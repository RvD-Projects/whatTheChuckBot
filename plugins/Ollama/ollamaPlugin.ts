...
export class OllamaPlugin {
  static Models: AIModel[] = [
    ...
    },
    {
      ...
      alias: "gemma-2b",
      description:
        "Gemma-2b is a family of lightweight, state-of-the-art open models built by Google DeepMind",
    },
    {
      id: 52,
      name: "gemma:latest",
      alias: "gemma",
      description:
        "Gemma-7b is a family of lightweight, state-of-the-art open models built by Google DeepMind.",
    },
    {
      id: 53,
    ...
    },
    {
      ...
      alias: "drummer",
      description:
        "Our faster AI drum sequencer creates custom drum patterns instantly, perfect for musicians and producers.",
    },
    {
      id: 55,
      name: "phi3:latest",
  ...
  static DefaultModel = OllamaPlugin.Models.find(
    (m) => m.alias === "llava-llama3"
  );
