export const ollamaModels = {
  ...
  "gemma-2b": {
    ...
    id: 17,
    description:
      "Gemma Model is Google's Open Source Model based on Gemini Models. This Modelfile load he 2b-instruct variant with a suitable System message.",
    Latency: "",
  },
  "gemma-7b": {
    name: "gemma:7b",
  ...
  "jeff-bezos": {
    ...
    id: 96,
    description:
      "This is a simple modelfile that acts as Jeff Bezos, narrating an engaging story about the evolution of Amazon, capturing his distinctive style and business philosophy.",
    Latency: "",
  },
  ...
  based: {
    ...
    id: 100,
    description:
      "Ask any question and get a based unfiltered and uncensored response",
    Latency: "",
  },
  "life-coach": {
  ...
  "hub/web-design-consultant:latest": {
    ...
    id: 155,
    description:
      "This is a simple modelfile that acts as a web design consultant.",
    Latency: "",
  },
  ...
  "hub/wygocuxyco/trash_talker:latest": {
    ...
    id: 158,
    description:
      "This character is a living, breathing middle finger to the establishment - a testament to the power of free speech and non-conformity.",
    Latency: "",
  },
